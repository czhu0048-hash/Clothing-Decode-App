...
async def analyze_sustainability(composition: str, brand: str | None = None) -> str:
    ...
    prompt = (
        ...
        "7. brand_rating: Based on your training knowledge, return the brand's likely rating "
        "from the Good On You scale. You MUST return ONLY one of these exact label strings - nothing else:\n"
        "   'Great' | 'Good' | \"It's a Start\" | 'Not Good Enough' | 'We Avoid' | null\n"
        "   - Use null if the brand is unknown, small, or you are not confident.\n"
        "   - NEVER return a sentence, explanation, or description.\n"
        "   - NEVER return 'N/A'. Only a label string or null.\n"
        "   Examples: 'Not Good Enough' for fast-fashion giants, 'Good' for brands with known sustainability programs, null for niche or unrecognised brands.\n"
